...
typedef struct {
    ...
    /* physical address */
    unsigned char*
        pbufY; // luma frame pointer or top field pointer(for field tile)
    unsigned char*
        pbufCb; // chroma frame pointer or top field pointer(for field tile)
    ...
    // unsigned char* pbufCr_tilebot;	//not required since always enable
    // interleave for tile

    /* virtual address */
    unsigned char*
        pbufVirtY; // luma frame pointer or top field pointer(for field tile)
    unsigned char*
        pbufVirtCb; // chroma frame pointer or top field pointer(for field tile)
    ...
    // unsigned char* pbufVirtCr_tilebot;	//not required since always
    // enable interleave for tile
