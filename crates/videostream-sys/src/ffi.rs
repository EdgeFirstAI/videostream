...
pub const VSL_VERSION: &[u8; 6] = b"2.6.0\0";
...
impl VideoStreamLibrary {
        ...
        L: Into<::libloading::Library>,
    {
        ...
        let vsl_camera_buffer_sequence = __library
            ...
            .map(|sym| *sym);
        let vsl_camera_buffer_flags = __library
            .get(b"vsl_camera_buffer_flags\0")
            .map(|sym| *sym);
