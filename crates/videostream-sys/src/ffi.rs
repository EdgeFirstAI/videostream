...
pub const VSL_VERSION: &[u8; 6] = b"2.1.3\0";
...
#[doc = " Video capture device (camera, frame grabber)"]
pub const VSLDeviceType_VSL_V4L2_TYPE_CAMERA: VSLDeviceType = 1;
#[doc = " Video output device (display, transmitter)"]
pub const VSLDeviceType_VSL_V4L2_TYPE_OUTPUT: VSLDeviceType = 2;
#[doc = " Video encoder (M2M: raw input → compressed output)"]
...
#[doc = " Image/video processor (M2M: raw input → raw output)"]
...
#[doc = " Resolution descriptor with supported frame rates"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct VSLResolution {
    ...
    pub height: u32,
    #[doc = "< Supported frame rates"]
    pub frame_rates: [VSLFrameRate; 16usize],
    #[doc = "< Number of frame rates"]
...
#[doc = " Pixel format descriptor"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct VSLFormat {
    #[doc = "< V4L2 pixel format fourcc code"]
    pub fourcc: u32,
    #[doc = "< Human-readable description"]
    pub description: [::std::os::raw::c_char; 32usize],
    #[doc = "< V4L2_FMT_FLAG_* flags"]
    pub flags: u32,
    #[doc = "< True if this is a compressed format"]
    pub compressed: bool,
...
#[doc = " List of discovered V4L2 devices"]
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct VSLDeviceList {
    #[doc = "< Array of devices"]
...
impl VideoStreamLibrary {
    ...
    #[doc = " Free a device list returned by enumeration functions.\n\n @param list Device list to free (NULL is safe)"]
    ...
    #[doc = " Find the first decoder supporting a specific input codec.\n\n @param codec_fourcc Input codec fourcc (e.g., VSL_FOURCC('H','E','V','C'))\n @return Device path string (static, do not free), or NULL if not found"]
