...
pub const VSL_VERSION: &[u8; 6] = b"2.5.0\0";
...
impl VideoStreamLibrary {
    ...
    #[doc = " Returns the capture-source frame sequence number for this buffer. @since 2.5"]
    ...
    #[doc = " Returns the V4L2 color space (primaries) negotiated for the camera. @since 2.5"]
    ...
    #[doc = " Returns the V4L2 transfer function negotiated for the camera. @since 2.5"]
    ...
    #[doc = " Returns the V4L2 YCbCr encoding negotiated for the camera. @since 2.5"]
    ...
    #[doc = " Returns the V4L2 quantization (color range) negotiated for the camera. @since 2.5"]
